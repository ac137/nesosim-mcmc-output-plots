...
# make into a big external for loop
...
for current_year in range(1980,2019):
	if current_year in (1987,2000,2001,2002):
		continue
	...
	print('completed all iterations for year {}'.format(current_year))
